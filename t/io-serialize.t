...
my Hash $body = PDF::IO::Serializer.new.body( $pdf )[0];
...
is $writer.write( :ind-obj(@objects[0].value)), "1 0 obj << /Name /Heyd#c9#99r#20#c6#8fliyev >>\nendobj\n", 'name write';
...
is $writer.write( :ind-obj(@objects-renumbered[0].value)), "1000 0 obj << /Name /Heyd#c9#99r#20#c6#8fliyev >>\nendobj\n", 'renumbered write';
