...
dies-ok { $pdf = PDF.open: "t/encrypt-aes.pdf", :password<dunno> }, "open encrypted with incorrect password - dies";

lives-ok { $pdf = PDF.open("t/encrypt-aes.pdf", :password($user-pass)) }, 'open with user password - lives';
