...
=end pod
    ...
    has PDF::Object::TextString $.Title is entry( :coerce );     #| (Optional; PDF 1.1) The document’s title.
    has PDF::Object::TextString $.Author is entry( :coerce );    #| (Optional) The name of the person who created the document.
    has PDF::Object::TextString $.Subject is entry( :coerce );   #| (Optional; PDF 1.1) The subject of the document.
    has PDF::Object::TextString $.Keywords is entry( :coerce );  #| (Optional; PDF 1.1) Keywords associated with the document.
    has PDF::Object::TextString $.Creator is entry( :coerce );   #| (Optional) If the document was converted to PDF from another format, the name of the application (for example, Adobe FrameMaker®) that created the original document from which it was converted.
    has PDF::Object::TextString $.Producer is entry( :coerce );  #| (Optional) If the document was converted to PDF from another format, the name of the application (for example, Acrobat Distiller) that converted it to PDF.
